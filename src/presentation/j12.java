    ...
    public j12(int x) throws DamasException{
    ...
    private  void setItem() throws DamasException{
        ...
        turnoJ2 = 1;
        if(name1 == null || name1 == ""){
            throw new DamasException(DamasException.J1_NOMBRE_INCORRECTO);
        }
    ...
    private  void setItem(int x) throws DamasException{
        color1 = seleccionColorJ1();
        name1 = nombrej1.getText();
        turnoJ1 = 0;
        if(name1 == null || name1 == ""){
    ...
    public void prepareElementsGameSelect1P(Color color1, String name, int turnoJ1){
        DamasGUI.getGUI().prepareElementsGameSelect1P(color1, name1, turnoJ1);
